...
@mcp.tool(
    description="Recommends outfit and items to bring based on today's weather and calendar schedule from 아참!(Ahcham). Provide city name and date (today/tomorrow), and optionally today's schedule. If city is unknown, ask the user which city to use.",
    annotations={
...
async def get_outfit_and_checklist(city: str = "", date: str = "today", schedule: str = "") -> str:
    ...
    # 출력: 날씨 → 일정 → 옷차림 → 준비물
    result = f"아참! 나가기 전에 확인하세요! ({city_display} · {date_label})\n\n"
